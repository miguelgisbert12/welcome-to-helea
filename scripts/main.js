...
const mainMenuElements = [
    ...
    "/media/img/female-character/female_happy.png",
    "/media/img/female-character/female_worried.png",
    "/media/img/female-character/female_confused.png",
    "/media/img/female-character/female_normal.png",
    "/media/img/female-character/female_fullbody.png",

    "/media/img/male-character/male_happy.png",
    "/media/img/male-character/male_worried.png",
    "/media/img/male-character/male_confused.png",
    "/media/img/male-character/male_normal.png",
    "/media/img/male-character/male_fullbody.png",

    "/media/img/non-binary-character/nobinary_happy.png",
    "/media/img/non-binary-character/nobinary_worried.png",
    "/media/img/non-binary-character/nobinary_confused.png",
    "/media/img/non-binary-character/nobinary_normal.png",
    "/media/img/non-binary-character/nobinary_fullbody.png",
